...
> **👀 Not a developer?** This post doubles as the complete user guide for ShowOff. Skip the code and start at [📘 Your Complete User Guide](#your-complete-user-guide-how-to-use-showoff). The technical deep dives are all in the second half — nobody will quiz you on them. **🧑💻 Developer?** Jump to [The Motivation](#the-motivation-why-build-showoff) or anywhere in the architecture/features sections below.

### The User Guide (For Everyone)
- [Your Complete User Guide: How to Use ShowOff](#your-complete-user-guide-how-to-use-showoff)

### The Story
- [Quick Facts: The TL;DR](#quick-facts-the-tldr)
...
This section is for **everyone** — no coding knowledge needed. If you just want to read, write, and share on ShowOff, everything you need is here. (If you're a developer, the deep dives start at [The Motivation](#the-motivation-why-build-showoff), but I'd still skim this — it's the product view.)
...
**🧑‍💻 Developers:** the full backend deep dive is in [Architecture Overview](#architecture-overview-how-the-pieces-fit) and [Appendix A](#appendix-a-full-api-reference-every-endpoint).
...
**🧑‍💻 Developers:** the frontend deep dive is in [Frontend Architecture](#frontend-architecture-routing-state-api-layer) and [Appendix D](#appendix-d-frontend-routes-and-pages).
...
**🧑‍💻 Developers:** the whole pipeline with code is in [The AI Cover Pipeline](#the-ai-cover-pipeline-the-showstopper).
...
**🧑‍💻 Developers:** all the war stories are in [Deployment & Production Ops](#deployment-and-production-ops-the-war-stories).
...
If your post landed in a surprising category, that's the algorithm doing its keyword math — you can see how in [the deep dive](#auto-categorization-the-keyword-frequency-algorithm).
...
|---|---|
| AI covers | [The AI Cover Pipeline — The Showstopper](#the-ai-cover-pipeline-the-showstopper) |
| Where images go | [The Media Lifecycle — Tracking Every Image](#the-media-lifecycle-tracking-every-image) |
| Categories | [The Blog Engine — Editor, Search, Categories & More](#the-blog-engine-editor-search-categories-and-more) |
| Devlogs | [Project Showcase & Devlog Timelines](#project-showcase-and-devlog-timelines) |
| Bookmarks/likes/comments | [Social Features — Bookmarks, Likes, Nested Comments & Sharing](#social-features-bookmarks-likes-nested-comments-and-sharing) |
| Account deletion | [The User System — Register, Login, Profile & Deletion](#the-user-system-register-login-profile-and-deletion) |
| Cookies & security | [Authentication & Security](#authentication-and-security-jwt-cookies-hashed-tokens-rate-limits) |
...
> 👩‍💻 **User guide card:** the user-facing editor tour lives in [Step 1 — The editor, in 60 seconds](#the-writers-guide-publishing-your-first-post). This deep dive is how it's built.
...
> 👩‍💻 **User guide card:** wondering what actually happens when you hit Publish? The human version is in [Step 3 — Hitting Publish](#the-writers-guide-publishing-your-first-post). Below is the machine version.
...
> 👩‍💻 **User guide card:** "why did my post land in Databases?" — the answer for non-coders is in [Step 3 — Hitting Publish](#the-writers-guide-publishing-your-first-post). Here's the actual algorithm.
...
> 👩‍💻 **User guide card:** the walkthrough of what a visitor sees on a project page is in [What's on a project page](#the-project-showcase-guide). Here's the design breakdown.
...
> 👩‍💻 **User guide card:** how saving works from the reader's chair is in [Bookmarks — read it later, everywhere](#social-and-community-guide). The engineering below is the polymorphic trick.
...
> 👩‍💻 **User guide card:** how replying works for real users is in [Comments — nested, formatted, and safe to delete](#social-and-community-guide). Below is the threading logic.
